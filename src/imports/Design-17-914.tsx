import svgPaths from "./svg-2qt2vtx41s";
...
function Group() {
  return (
    <div className="absolute contents h-[calc(1px*((var(--transform-inner-width)*0.08193850517272949)+(var(--transform-inner-height)*0.9966373443603516)))] left-[calc(50%-471.12px)] top-[calc(50%+132.146px)] translate-x-[-50%] translate-y-[-50%] w-[calc(1px*((var(--transform-inner-height)*0.08193850517272949)+(var(--transform-inner-width)*0.9966373443603516)))]">
      <div className="absolute flex h-[calc(1px*((var(--transform-inner-width)*0.08193850517272949)+(var(--transform-inner-height)*0.9966373443603516)))] items-center justify-center left-[calc(50%-471.12px)] top-[calc(50%+132.146px)] translate-x-[-50%] translate-y-[-50%] w-[calc(1px*((var(--transform-inner-height)*0.08193850517272949)+(var(--transform-inner-width)*0.9966373443603516)))]" style={{ "--transform-inner-width": "263", "--transform-inner-height": "374" } as React.CSSProperties}>
      ...
      <div className="absolute flex h-[calc(1px*((var(--transform-inner-width)*0.08193851487498112)+(var(--transform-inner-height)*0.9966373451580218)))] items-center justify-center left-[calc(50%-468.579px)] top-[calc(50%+124.672px)] translate-x-[-50%] translate-y-[-50%] w-[calc(1px*((var(--transform-inner-height)*0.08193849547047875)+(var(--transform-inner-width)*0.9966373435626813)))]" style={{ "--transform-inner-width": "171.28125", "--transform-inner-height": "191.515625" } as React.CSSProperties}>
        <div className="flex-none rotate-[355.3deg]">
      ...
      <div className="absolute flex h-[calc(1px*((var(--transform-inner-width)*0.08193850517272949)+(var(--transform-inner-height)*0.9966373443603516)))] items-center justify-center left-[calc(50%-523.727px)] top-[calc(50%+232.175px)] w-[calc(1px*((var(--transform-inner-height)*0.08193850517272949)+(var(--transform-inner-width)*0.9966373443603516)))]" style={{ "--transform-inner-width": "130.015625", "--transform-inner-height": "57" } as React.CSSProperties}>
        <div className="flex-none rotate-[355.3deg]">
          <p className="font-['Gilroy-ExtraBold:☞',_sans-serif] h-[57.003px] leading-[51.233px] not-italic relative text-[#353739] text-[40px] w-[130.021px]">Guitar</p>
        </div>
      </div>
    </div>
  );
...
function Group12() {
  return (
    <div className="absolute contents h-[calc(1px*((var(--transform-inner-width)*0.024810709059238434)+(var(--transform-inner-height)*0.9996922016143799)))] left-[calc(50%-159.401px)] top-[328px] translate-x-[-50%] w-[calc(1px*((var(--transform-inner-height)*0.024810709059238434)+(var(--transform-inner-width)*0.9996922016143799)))]">
      <div className="absolute flex h-[calc(1px*((var(--transform-inner-width)*0.02481070905923842)+(var(--transform-inner-height)*0.9996922016143799)))] items-center justify-center left-[calc(50%-159.401px)] top-[328px] translate-x-[-50%] w-[calc(1px*((var(--transform-inner-height)*0.02481070905923842)+(var(--transform-inner-width)*0.9996922016143799)))]" style={{ "--transform-inner-width": "263", "--transform-inner-height": "374" } as React.CSSProperties}>
      ...
      <div className="absolute flex h-[calc(1px*((var(--transform-inner-width)*0.02481070905923842)+(var(--transform-inner-height)*0.9996922016143799)))] items-center justify-center left-[calc(50%-172.382px)] top-[383.99px] translate-x-[-50%] w-[calc(1px*((var(--transform-inner-height)*0.02481070905923842)+(var(--transform-inner-width)*0.9996922016143799)))]" style={{ "--transform-inner-width": "206.515625", "--transform-inner-height": "204" } as React.CSSProperties}>
        <div className="flex-none rotate-[358.578deg]">
      ...
      <div className="absolute flex h-[calc(1px*((var(--transform-inner-width)*0.02481070905923842)+(var(--transform-inner-height)*0.9996922016143799)))] items-center justify-center left-[calc(50%-217.376px)] top-[617.67px] w-[calc(1px*((var(--transform-inner-height)*0.02481070905923842)+(var(--transform-inner-width)*0.9996922016143799)))]" style={{ "--transform-inner-width": "121", "--transform-inner-height": "62" } as React.CSSProperties}>
        <div className="flex-none rotate-[358.578deg]">
          <p className="font-['Gilroy-ExtraBold:☞',_sans-serif] h-[62px] leading-[60.278px] not-italic relative text-[#1e1e1e] text-[40px] w-[121px]">Piano</p>
        </div>
      </div>
    </div>
  );
...
function Group1() {
  return (
    <div className="absolute contents h-[calc(1px*((var(--transform-inner-width)*0.08193851262331009)+(var(--transform-inner-height)*0.9966374039649963)))] left-[calc(50%+158.88px)] top-[332px] translate-x-[-50%] w-[calc(1px*((var(--transform-inner-height)*0.08193851262331009)+(var(--transform-inner-width)*0.9966374039649963)))]">
      <div className="absolute flex h-[calc(1px*((var(--transform-inner-width)*0.0819385126233101)+(var(--transform-inner-height)*0.9966374039649963)))] items-center justify-center left-[calc(50%+158.88px)] top-[332px] translate-x-[-50%] w-[calc(1px*((var(--transform-inner-height)*0.0819385126233101)+(var(--transform-inner-width)*0.9966374039649963)))]" style={{ "--transform-inner-width": "263", "--transform-inner-height": "374" } as React.CSSProperties}>
      ...
      <div className="absolute flex h-[calc(1px*((var(--transform-inner-width)*0.08193851262331008)+(var(--transform-inner-height)*0.9966374039649963)))] items-center justify-center left-[calc(50%+169.275px)] top-[415.25px] translate-x-[-50%] w-[calc(1px*((var(--transform-inner-height)*0.08193851262331008)+(var(--transform-inner-width)*0.9966374039649963)))]" style={{ "--transform-inner-width": "197.359375", "--transform-inner-height": "208" } as React.CSSProperties}>
        <div className="flex-none rotate-[4.7deg]">
      ...
      <div className="absolute flex h-[calc(1px*((var(--transform-inner-width)*0.08193851262331008)+(var(--transform-inner-height)*0.9966374039649963)))] items-center justify-center left-[calc(50%+91.276px)] top-[633.23px] w-[calc(1px*((var(--transform-inner-height)*0.08193851262331008)+(var(--transform-inner-width)*0.9966374039649963)))]" style={{ "--transform-inner-width": "111.8125", "--transform-inner-height": "41" } as React.CSSProperties}>
        <div className="flex-none rotate-[4.7deg]">
          <p className="font-['Gilroy-ExtraBold:☞',_sans-serif] h-[41px] leading-[35px] not-italic relative text-[#353739] text-[40px] w-[111.824px]">Drum</p>
        </div>
      </div>
    </div>
  );
...
function Group2() {
  return (
    <div className="absolute contents h-[calc(1px*((var(--transform-inner-width)*0.1264197677373886)+(var(--transform-inner-height)*0.9919768571853638)))] left-[calc(50%+477.585px)] top-[361px] translate-x-[-50%] w-[calc(1px*((var(--transform-inner-height)*0.1264197677373886)+(var(--transform-inner-width)*0.9919768571853638)))]">
      <div className="absolute flex h-[calc(1px*((var(--transform-inner-width)*0.1264197677373886)+(var(--transform-inner-height)*0.9919768571853638)))] items-center justify-center left-[calc(50%+477.585px)] top-[361px] translate-x-[-50%] w-[calc(1px*((var(--transform-inner-height)*0.1264197677373886)+(var(--transform-inner-width)*0.9919768571853638)))]" style={{ "--transform-inner-width": "263", "--transform-inner-height": "374" } as React.CSSProperties}>
      ...
      <div className="absolute flex h-[calc(1px*((var(--transform-inner-width)*0.1264197677373886)+(var(--transform-inner-height)*0.9919768571853638)))] items-center justify-center left-[calc(50%+403.568px)] top-[664.23px] w-[calc(1px*((var(--transform-inner-height)*0.1264197677373886)+(var(--transform-inner-width)*0.9919768571853638)))]" style={{ "--transform-inner-width": "111.8125", "--transform-inner-height": "41" } as React.CSSProperties}>
        <div className="flex-none rotate-[7.263deg]">
          <p className="font-['Gilroy-ExtraBold:☞',_sans-serif] h-[41px] leading-[35px] not-italic relative text-[#353739] text-[40px] w-[111.824px]">Vocal</p>
        </div>
      </div>
      <div className="absolute flex h-[calc(1px*((var(--transform-inner-width)*0.1264197677373886)+(var(--transform-inner-height)*0.9919768571853638)))] items-center justify-center left-[calc(50%+475.026px)] top-[448.52px] translate-x-[-50%] w-[calc(1px*((var(--transform-inner-height)*0.1264197677373886)+(var(--transform-inner-width)*0.9919768571853638)))]" style={{ "--transform-inner-width": "170.484375", "--transform-inner-height": "166" } as React.CSSProperties}>
        <div className="flex-none rotate-[7.263deg]">
...
function StatusBarIPhone3() {
  return (
    <div className="absolute bg-white box-border content-stretch flex flex-col h-[50px] items-start left-0 pb-0 pt-[21px] px-0 top-0 w-[1347px]" data-name="Status Bar - iPhone">
      <Frame4 />
    </div>
  );
}
...
function Piano() {
  return (
    <div className="absolute bg-white h-[852px] left-[102px] overflow-x-auto overflow-y-clip rounded-[20px] shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] top-[1278px] w-[1335px]" data-name="Piano">
      <div className="absolute font-['Gilroy-ExtraBold:☞',_sans-serif] h-[86px] leading-[40.676px] left-[46px] not-italic text-[#353739] text-[37.189px] top-[85px] w-[302.162px]">
        <p className="mb-0">{`Hey Sandra 👋 `}</p>
        <p>Ready to jam?</p>
      </div>
